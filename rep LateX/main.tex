...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.75\linewidth]{../src/images/steps.png}
...
There are many practical uses of this protocol, an example could be the following. Imagine you are an employee in a corporation and you want to know the average salary without revealing to anyone your income; in this scenario you can the use the \textit{SMPC} protocol to obtain the average. 
