...
\begin{figure}[!h]
    \centering
    \includegraphics[width=0.95\linewidth]{../src/images/steps.png}
    \caption{Steps of the SMPC}\label{steps}
\end{figure}

\footnote{Image \ref{steps} was taken from \url{https://web.engr.oregonstate.edu/~rosulekm/cryptabit/1-overview.pdf}\\
Image \ref{half} was taken over \url{https://upload.wikimedia.org/wikipedia/commons/1/14/Half-adder.svg}\\ 
Image \ref{full} was taken over \url{https://upload.wikimedia.org/wikipedia/commons/a/a9/Full-adder.svg}.}
...
The circuit uses 7 full adders and 1 half adder, represented in figures \ref{half} \ref{full}, concatenated together; the implementation of the entire circuit is represented in figure \ref{circuit}.
